...
public:
    ...
    void fromCbor(const QCborMap& map) override {
        ...
        if (!tmpValue.isNull()) {
            active_ = tmpValue.toBool();active_.fromCbor(tmpValue.toMap());
        }
...
public:
    ...
    void fromCbor(const QCborMap& map) override {
        ...
        if (!tmpValue.isNull()) {
            data_ = tmpValue.toString();data_.fromCbor(tmpValue.toMap());
        }
        tmpValue = map.value(QLatin1String("config"));
        if (!tmpValue.isNull()) {
            config_ = tmpValue.toString();config_.fromCbor(tmpValue.toMap());
        }
    }
