...
class MODEL_EXPORT InheritedCrossBlockBlock : public BaseBlockBlock, public IBlock {
public:
...
class MODEL_EXPORT AdvancedCrossBlockBlock : public ExtendedBlockBlock, public IBlock {
public:
    AdvancedCrossBlockBlock() = default;
    
    // 实现 IBlock 接口
    QCborMap toCbor() const override {
        QCborMap map = ExtendedBlockBlock::toCbor();
    ...
    void fromCbor(const QCborMap& map) override {
        ExtendedBlockBlock::fromCbor(map);
        QCborValue tmpValue;
...
class MODEL_EXPORT InheritedCrossStructModel : public StructBaseBlockModel, public IModel {
public:
...
class MODEL_EXPORT UltimateCrossTestModel : public AllTypesBlockModel, public IModel {
public:
    UltimateCrossTestModel() = default;
    
    // 实现 IModel 接口
    QCborMap toCbor() const override {
        QCborMap map = AllTypesBlockModel::toCbor();
                ...
                map.insert(QLatin1String("basicStruct"), basicStruct_.toCbor());
                map.insert(QLatin1String("inheritedStruct"), inheritedStruct_.toCbor());
                map.insert(QLatin1String("crossEnum"), crossEnum_.toCbor());
                map.insert(QLatin1String("crossBlock"), crossBlock_.toCbor());
    ...
    void fromCbor(const QCborMap& map) override {
        AllTypesBlockModel::fromCbor(map);
        QCborValue tmpValue;
        ...
        tmpValue = map.value(QLatin1String("basicStruct"));
        if (!tmpValue.isNull()) {
            basicStruct_.fromCbor(tmpValue.toMap());
        }
        tmpValue = map.value(QLatin1String("inheritedStruct"));
        if (!tmpValue.isNull()) {
            inheritedStruct_.fromCbor(tmpValue.toMap());
        }
        tmpValue = map.value(QLatin1String("crossEnum"));
        if (!tmpValue.isNull()) {
            crossEnum_.fromCbor(tmpValue.toMap());
    ...
    QString fieldType(const QString& fieldName) const override {
        ...
        if (fieldName == QLatin1String("basicStruct")) return QLatin1String("examples.structs.BasicStruct");
        if (fieldName == QLatin1String("inheritedStruct")) return QLatin1String("examples.structs.InheritedStruct");
        if (fieldName == QLatin1String("crossEnum")) return QLatin1String("CrossEnum");
        if (fieldName == QLatin1String("crossBlock")) return QLatin1String("CrossBlock");
    ...
    QString fieldContainerType(const QString& fieldName) const override {
        ...
        if (fieldName == QLatin1String("basicStruct")) return QLatin1String("none");
        if (fieldName == QLatin1String("inheritedStruct")) return QLatin1String("none");
        if (fieldName == QLatin1String("crossEnum")) return QLatin1String("none");
        if (fieldName == QLatin1String("crossBlock")) return QLatin1String("none");
    ...
    examples:structs::BasicStructModel getBasicStruct() const { return basicStruct_; }
    void setBasicStruct(const examples:structs::BasicStructModel& value) { basicStruct_ = value; }
    examples:structs::InheritedStructModel getInheritedStruct() const { return inheritedStruct_; }
    void setInheritedStruct(const examples:structs::InheritedStructModel& value) { inheritedStruct_ = value; }
    CrossEnum getCrossEnum() const { return crossEnum_; }
    void setCrossEnum(const CrossEnum& value) { crossEnum_ = value; }
    CrossBlockBlock getCrossBlock() const { return crossBlock_; }
    void setCrossBlock(const CrossBlockBlock& value) { crossBlock_ = value; }
...
private:
    ...
    examples:structs::BasicStructModel basicStruct_;
    examples:structs::InheritedStructModel inheritedStruct_;
    CrossEnum crossEnum_ = /* complex expression */;
    CrossBlockBlock crossBlock_;
