...
private:
    SimpleEnum simpleField_ = /* complex expression */;
    ValueEnum valueField_ = /* complex expression */;
    ...
    std::optional<ValueEnum> optionalValue_ = /* complex expression */;
...
private:
    ...
    QVector<ValueEnum> valueArray_;
    std::optional<SimpleEnum> optionalSimple_ = /* complex expression */;
