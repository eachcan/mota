...
function parseDocument(text, uri) {
    ...
    for (let i = 0; i < lines.length; i++) {
        ...
        while ((match = enumRegex.exec(line)) !== null) {
            ...
            (0, symbols_1.addSymbol)(fullName, 'enum', uri, range);
        }
        // 匹配结构体定义
        ...
        while ((match = structRegex.exec(line)) !== null) {
            ...
            (0, symbols_1.addSymbol)(fullName, 'struct', uri, range);
            // 如果有基类型，添加引用
            if (baseType) {
                const baseFullName = currentNamespace ? `${currentNamespace}.${baseType}` : baseType;
                (0, symbols_1.addReference)(baseFullName, uri, {
        ...
        while ((match = blockRegex.exec(line)) !== null) {
            ...
            (0, symbols_1.addSymbol)(fullName, 'block', uri, range);
        }
        // 匹配注解定义
        ...
        while ((match = annotationRegex.exec(line)) !== null) {
            ...
            (0, symbols_1.addSymbol)(fullName, 'annotation', uri, range, parameters);
        }
        // 匹配字段定义
        ...
        while ((match = fieldRegex.exec(line)) !== null) {
            ...
            (0, symbols_1.addSymbol)(fullName, 'field', uri, range);
            // 添加类型引用
            const typeFullName = type.includes('.') ? type : (currentNamespace ? `${currentNamespace}.${type}` : type);
            (0, symbols_1.addReference)(typeFullName, uri, {
        ...
        while ((match = annotationUsageRegex.exec(line)) !== null) {
            ...
            // 添加注解引用
            (0, symbols_1.addReference)(annotationFullName, uri, {
